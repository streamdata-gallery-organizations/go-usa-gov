...
info:
  ...
  description: the-gousagov-api-can-shorten-a-url-preview-the-destination-of-a-short-url-get-the-number-of-clicks-on-a-short-url-export-short-urls-from-an-account
...
paths:
  ...
  export.json:
    get:
      ...
      x-api-path-slug: exportjson-get
      responses:
        200:
          description: OK
      tags:
